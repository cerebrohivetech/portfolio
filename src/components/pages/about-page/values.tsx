...
export function Values() {
    ...
    return (
        <Section className="flex flex-col gap-[64px] bg-[url('/bg-image.svg')] justify-between lg:flex-row lg:gap-20 xl:gap-[144px]">
            ...
            <div className="flex flex-col gap-[64px] md:gap-[89px] sm:w-[608px]">
                <div>
