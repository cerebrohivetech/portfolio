...
function IndividualService(props: ServiceProp) {
    ...
    return (
        <div>
            ...
            <div className="mb-[24px] flex flex-col justify-between gap-[24px] text-sm/snug text-[#E3E1E1] md:flex-row lg:gap-[40px] lg:text-xl/[2.35rem] [&>p]:w-full md:[&>p]:w-[580px]">
                <p>{firstParagraph}</p>
                <p>{secondParagraph}</p>
            </div>
            <Button
