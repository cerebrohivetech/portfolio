...
export function CaseStudyDisplay({
    ...
    return (
        <div
            className={`${className} relative bg-second-20 border-first-90 mx-auto flex h-[320px] w-full overflow-hidden rounded-xl rounded-b-none border-2 border-b-0 pt-[24px] md:h-[400px] lg:h-[560px] lg:w-[350px] lg:rounded-b-xl lg:border-b-2 lg:pt-0 xl:w-[422px] 2xl:w-[432px]`}
        >
            <div className="m-auto z-10">
                <CaseStudyImage src={image} alt="" />
            </div>
            {isBlur && <div className="w-[200px] h-[200px] rounded-full inset-x-[42%] inset-y-[30%] z-0 bg-second-110/80 absolute blur-[364px]"></div>}
        </div>
    );
}
