    ...
    return (
        <Hero className="text-second-10">
            <div className="px-[20px] pt-[32px] pb-[48px] sm:px-[40px] md:px-[50px] md:pt-[96px] md:pb-[80px] lg:px-[100px]">
                <div className="flex flex-col gap-[24px] mb-[10px] sm:mb-[20px] md:mb-[30px] lg:mb-[40px] xl:mb-[54px] md:gap-[30px] lg:flex-row lg:gap-[50px] xl:gap-[80px]">
                    ...
                    <div className="flex flex-col items-start gap-[24px] md:gap-[32px]">
                        <p className="w-[335px] lg:w-[413px] text-sm/[1.375rem] sm:text-base font-normal md:text-[1.125rem]/[1.875rem] 2xl:w-[490px]">
